...
const MainContent = () => {
    ...
    const [dorpdownOpen,setDorpDown]=useState(false)
  ...
  return (
    <section className='xl:w-[55rem] lg:w-[55rem] sm:w-[40rem] xs:w-[20rem] p-5'>
        <div className='mb-5'>
            <div className='flex flex-col sm:flex-row jsutify-between items-center'>
                <div className='relative mb-5 mt-5'>
                    <button onClick={()=>setDorpDown(!dorpdownOpen)} className='border:none px-4 py-2 rounded-full flex items-center'>
            ...
            <div className='grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 gap-5'>
                {filteredProducts.map(product=>(
                    <BookCard key={product.id} id={product.id} title={product.title} image={product.thumbnail} price={product.price}></BookCard>
                ))}
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-5">
                ...
                disabled={currentPage===1} className='border px-4 py-2 mx-2 rounded-full'>Previous</button>
                ...
                <button onClick={()=>handlePageChange(currentPage+1)}
                    disabled={currentPage===totalPages} className='border px-4 py-2 mx-2 rounded-full'>Next</button>
